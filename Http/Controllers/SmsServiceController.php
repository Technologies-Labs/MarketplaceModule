...
use Modules\MarketplaceModule\Entities\SmsService as SmsServiceModel;
use Modules\MarketplaceModule\Services\SmsService;
use Modules\MarketplaceModule\Services\SmsService as ServicesSmsService;
...
class SmsServiceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('marketplacemodule::dashboard.smsServices.index',compact('smsServices'));
    }
    ...
    {
        $users =User::get();
        return view('marketplacemodule::dashboard.smsServices.create',compact('users'));
    }
    ...
    public function edit($id)
    {
        ...
        $users =User::get();
        return view('marketplacemodule::dashboard.smsServices.edit',compact('smsService','users'));
    }
