...
use Modules\MarketplaceModule\Services\SubscriptionService;
...
class SubscriptionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('marketplacemodule::dashboard.subscriptions.index',compact('subscriptions'));
    }
    ...
    public function create()
    {
        ...
        return view('marketplacemodule::dashboard.subscriptions.create',[
            'users'   =>$users,
            'services'=>$services,
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        $users =User::get();
        $services =Service::get();
        return view('marketplacemodule::dashboard.subscriptions.edit',[
